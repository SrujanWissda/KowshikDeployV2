...
import { ControlEffectivenessAgent, InherentAssessmentAgent } from './core/agents';
import { withTrace } from './core/observability';

// Instance ID to test (use the ID you provided)
const instanceId = '01b116b883ae0790fba8c4e0deaad3d7';
console.log(`Running Control Effectiveness and Inherent Assessment for ServiceNow Instance: ${instanceId}`);
